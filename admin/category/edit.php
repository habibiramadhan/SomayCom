...
try {
    ...
    error_log("Error loading edit category page: " . $e->getMessage());
...
<body class="bg-gray-50">
    ...
    <div class="ml-64 p-8">
        ...
        <div class="flex items-center mb-8">
            ...
            <div>
                ...
                <p class="text-gray-600">Edit kategori: <?php echo htmlspecialchars($category['name']); ?></p>
            </div>
        </div>
                    ...
                    <div class="bg-white rounded-xl shadow-md p-6">
                        ...
                        <div class="mb-6">
                            ...
                            <div class="relative inline-block">
                                <img src="../uploads/categories/<?php echo htmlspecialchars($category['image']); ?>" 
                                     class="preview-image rounded-lg border"
                                     onerror="this.style.display='none';">
                                <label class="absolute top-2 right-2 cursor-pointer">
                                    <input type="checkbox" name="delete_image" value="1" class="sr-only">
                                    <div class="bg-red-500 text-white p-2 rounded-full hover:bg-red-600 transition-colors">
                        ...
                        <div class="border-2 border-dashed border-gray-300 rounded-lg p-6 text-center">
                            ...
                            <label for="image" class="cursor-pointer">
                                ...
                                <p class="text-lg font-medium text-gray-700"><?php echo !empty($category['image']) ? 'Ganti gambar' : 'Upload gambar'; ?></p>
                        ...
                        <div id="image-preview" class="mt-4 hidden">
                            <h4 class="text-md font-medium text-gray-700 mb-3">Preview Gambar Baru</h4>
                ...
                <div class="space-y-6">
                    ...
                    <div class="bg-white rounded-xl shadow-md p-6">
                        ...
                        <div class="space-y-4">
                            <div>
                                ...
                                <input type="number" name="sort_order" value="<?php echo $formData['sort_order']; ?>" 
                                       min="0" step="1"
                                       class="w-full rounded-md border-gray-300 shadow-sm focus:border-primary focus:ring-primary"
                                       placeholder="0">
                    ...
                    <div class="bg-blue-50 rounded-xl p-6">
                        <h4 class="text-lg font-semibold text-blue-900 mb-3">
                            <i class="fas fa-info-circle mr-2"></i>Info Kategori
                        </h4>
                        <div class="text-sm text-blue-800 space-y-2">
                            <p><strong>Dibuat:</strong> <?php echo formatDate($category['created_at']); ?></p>
                            <p><strong>Diupdate:</strong> <?php echo formatDate($category['updated_at']); ?></p>
    ...
    <script>
        ...
        document.querySelector('input[name="delete_image"]').addEventListener('change', function() {
