<?php
// admin/shipping_area/edit.php
// Set page title
$page_title = 'Edit Area Pengiriman';
...
try {
    ...
    error_log("Error loading edit area page: " . $e->getMessage());
...
$formData = $_SESSION['form_data'] ?? $area;
...
<body class="bg-gray-50">
    ...
    <div class="ml-64 p-8">
        ...
        <div class="flex items-center mb-8">
            ...
            <div>
                <h1 class="text-3xl font-bold text-gray-900">Edit Area Pengiriman</h1>
                <p class="text-gray-600">Edit area: <?php echo htmlspecialchars($area['area_name']); ?></p>
            </div>
        </div>
                ...
                <div class="bg-white rounded-xl shadow-md p-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                            ...
                            <input type="number" name="shipping_cost" value="<?php echo $formData['shipping_cost']; ?>" 
        ...
        <div class="mt-8 max-w-2xl">
            <div class="bg-blue-50 rounded-xl p-6">
                <h4 class="text-lg font-semibold text-blue-900 mb-3">
                    <i class="fas fa-info-circle mr-2"></i>Info Area
                </h4>
                <div class="text-sm text-blue-800 space-y-2">
                    <p><strong>Dibuat:</strong> <?php echo formatDate($area['created_at']); ?></p>
                    <p><strong>Diupdate:</strong> <?php echo formatDate($area['updated_at']); ?></p>
                </div>
            </div>
        </div>
    </div>
